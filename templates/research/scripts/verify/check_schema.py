#!/usr/bin/env python3
"""Out-of-band schema check on data/results/claims.json.

PLAIN PYTHON -- no @stx.session decorator. This script lives OUTSIDE
the agent's Clew DAG so its execution doesn't pollute the validity-gate
chain.
"""
