...
# (project=scitex-template, owner=ywatanabe1989, repo=scitex-template,
...
TMPDIR="/tmp/publish-scitex_template-${GITHUB_RUN_ID:-0}-${GITHUB_RUN_ATTEMPT:-0}-$V"
export TMPDIR
rm -rf "$TMPDIR"
...
echo "PUBLISH-OK: scitex-template dist/* uploaded to PyPI via manual OIDC trusted publishing"
